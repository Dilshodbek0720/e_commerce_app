...
class ProductUpdateScreen extends StatefulWidget {
  ProductUpdateScreen({super.key, required this.productRepository, required this.productModel});
            ...
            GlobalButton(
                ...
                onTap: () async {
                  if (titleController.text.isNotEmpty &&
                    ...
                    ProductModel? product = await widget.productRepository.addProductUpdate(
                      updateId: widget.productModel.id,
